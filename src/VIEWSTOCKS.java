...
public class VIEWSTOCKS extends javax.swing.JFrame {
    ...
    public VIEWSTOCKS() {
        ...
        setTitle("MICROVERSE MOBILES PRIVATE LTD-STOCK DETAILS");
           ...
           ResultSet rs=st.executeQuery("SELECT * FROM `mobile`;");
            while(rs.next())
            {
                if(rs.getString(2).equals(jTextField1.getText())==true)
                {
                    ...
                    ss.executeUpdate("update mobile set Price='"+jTextField2.getText()+"' where ModelNo ='"+jTextField1.getText()+"'");
                    DefaultTableModel m=(DefaultTableModel)jTable1.getModel();
